...
insert into user_account (user_id, user_password, nickname, email, memo, created_at, created_by, modified_at, modified_by) values
    ('rowen', 'asdf1234', 'rowen', 'rowen@mail.com', 'I am rowen.', now(), 'rowen', now(), 'rowen')
;
insert into user_account (user_id, user_password, nickname, email, memo, created_at, created_by, modified_at, modified_by) values
    ('rowen2', 'asdf1234', 'rowen2', 'rowen2@mail.com', 'I am rowen.', now(), 'rowen', now(), 'rowen')
;

-- 123 게시글
insert into article (user_account_id, title, content, hash_tag, created_by, modified_by, created_at, modified_at) values
